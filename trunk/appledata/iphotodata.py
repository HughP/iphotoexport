...
#  }
    ...
    def readplaces(self, library_dir):
      ...
      cursor.execute("SELECT primaryKey, " +
      ...
      for row in cursor:
        (image_key, place_key, ocean, country, 
    ...
    def __init__(self, data, keyword_map, face_map):
      ...
      if face_list:
        for face_entry in face_list:
          ...
          # Other keys in face_entry: rectangle, face index
...
def get_iphoto_data(library_dir, album_xml_file, do_places):
