...
class AppleXMLResolver(xml.sax.handler.EntityResolver): #IGNORE:R0903
  ...
  def resolveEntity(self, publicId, systemId): #IGNORE:C0103
    '''Simple schema, resolve all entities to just the systemId'''
    return systemId

class AppleXMLHandler(xml.sax.handler.ContentHandler):
  ...
  def startElement(self, name, attributes): #IGNORE:C0103
